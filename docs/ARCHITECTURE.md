...
## Safe update rule
Edit the owning `src/` module, run `python3 tools/build.py`, run syntax/regression checks, then package the complete project. Do not directly edit generated `js/game.js` unless rebuilding immediately afterward.
